...
echo "The perimeter of rectangle one is: {$rectangle->perimeter()}" . PHP_EOL;

$rectangle2 = new Rectangle(5, 4);
echo "The area of rectangle two is: {$rectangle2->area()}" . PHP_EOL;
echo "The perimeter of rectangle two is: {$rectangle2->perimeter()}" . PHP_EOL;

$rectangle3 = new Rectangle(10, 10);
echo "The area of rectangle three is: {$rectangle3->area()}" . PHP_EOL;
echo "The perimeter of rectangle three is: {$rectangle3->perimeter()}" . PHP_EOL;
